...
This folder holds simple role notes for future Codex or AI-agent passes.

Keep each handoff small. The best agent task is one that can be finished without reading the whole archive.

Agents should prefer the interactive builder output structure instead of inventing new Markdown schemas.
